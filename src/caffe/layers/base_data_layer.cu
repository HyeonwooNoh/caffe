 ...
 */
template <typename Dtype>
void ImageSegCtrlPrefetchingDataLayer<Dtype>::Forward_gpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
  // First, join the thread
  BasePrefetchingDataLayer<Dtype>::JoinPrefetchThread();
  // Copy the data
 ...
 */
template <typename Dtype>
void ImageSegCtrlClsPrefetchingDataLayer<Dtype>::Forward_gpu(
    const vector<Blob<Dtype>*>& bottom, const vector<Blob<Dtype>*>& top) {
  // First, join the thread
  BasePrefetchingDataLayer<Dtype>::JoinPrefetchThread();
  // Copy the data
...
INSTANTIATE_LAYER_GPU_FORWARD(ImageSegCtrlPrefetchingDataLayer);
INSTANTIATE_LAYER_GPU_FORWARD(ImageSegCtrlClsPrefetchingDataLayer);
