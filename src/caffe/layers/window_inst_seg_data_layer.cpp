...
void WindowInstSegDataLayer<Dtype>::DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
  ...
  while (std::getline(infile, linestr)) {
    ...
    vector<int> window(WindowInstSegDataLayer::NUM);
    window[WindowInstSegDataLayer::X1] = x1;
    window[WindowInstSegDataLayer::Y1] = y1;
    window[WindowInstSegDataLayer::X2] = x2;
    window[WindowInstSegDataLayer::Y2] = y2;
    window[WindowInstSegDataLayer::INST_LABEL] = inst_label;
...
void WindowInstSegDataLayer<Dtype>::InternalThreadEntry() {
  ...
  for (int item_id = 0; item_id < batch_size; ++item_id) {
    ...
    int x1 = window[WindowInstSegDataLayer<Dtype>::X1];
    int y1 = window[WindowInstSegDataLayer<Dtype>::Y1];
    int x2 = window[WindowInstSegDataLayer<Dtype>::X2];
    int y2 = window[WindowInstSegDataLayer<Dtype>::Y2];
    int inst_label = window[WindowInstSegDataLayer<Dtype>::INST_LABEL];
    // compute padding 
